...
function Navigation (){
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
        ...
        const res = await fetch(`http://api.song.link/v1-alpha.1/links?url=spotify%3A${TRACK_TYPE}%3A${SPOTIFY_ID}&userCountry=US&key=9ab8abaf-c5f1-4edb-8e7f-7f72c7033693`);
